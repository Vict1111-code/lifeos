...
import { Brain, Check, Database, Loader2, RefreshCw, Trash2 } from 'lucide-react'
...
export function AIMemoryPanel() {
  ...
  return <section className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-4 sm:p-5">
    ...
    <div className="mt-3 flex flex-wrap items-center gap-2"><span className="inline-flex items-center gap-1.5 rounded-full bg-[var(--surface-2)] px-2.5 py-1 text-[10px] text-[var(--muted)]"><Database size={12}/>Semantic retrieval enabled</span><span className="text-[10px] text-[var(--muted)]">Relevant memories are ranked by meaning, confidence, importance, and recency.</span></div>
